...
MINER_ZIP_FN="nimbuspool-miner-linux-0.8.0-broadwell.zip"
MINER_URL="https://github.com/NimbusPool/miner/releases/download/v0.8.0/nimbuspool-miner-linux-0.8.0-broadwell.zip"
